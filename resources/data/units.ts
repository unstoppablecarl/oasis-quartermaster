...
export const UNITS: Record<string, Unit> = {
    ALBATROSS_1: {
        ...
        abilities: [
            ...
            'Weapon Cycling: 50mm Raillgun',
            'Reposition: Fixed Wing [8]',
        ],
    ...
    BANDIT_2: {
        ...
        weapons: [
            {
                name: '30MM Rotary Autocannon [2 ATKS]',
                range: '8',
                accuracy: '6',
                damage: '4',
                keywords: ['2x'],
        ...
        traits: ['Aircraft: VTOL', 'Laser Dazzler', 'Transport [1]'],
    ...
    BUFFALO_3: {
        ...
        traits: ['Grav Drive', 'Surveyor', 'Transport [2]'],
    ...
    BUFFALO_4: {
        ...
        weapons: [
            {
                name: '120MM Recoilless Rifle [AP]',
                range: '10',
                accuracy: '5',
                damage: '6+1',
                keywords: ['AP'],
            ...
            {
                name: 'Broadside Rockets [GND] [SPLASH 2"]',
                range: '6',
                accuracy: '4',
                damage: '4',
                keywords: ['Gnd', 'Spl'],
    ...
    CHARIOT_5: {
        ...
        weapons: [
            {
                name: '50MM Smart Munitions Autocannon',
                range: '12',
                accuracy: '6+2',
                damage: '4',
                keywords: [],
        ...
        abilities: ['Escort [8]', 'Smartburst Rounds'],
        traits: ['Transport [1]'],
        cards_front: [],
        card_back: '',
    },
    ...
    HOUND_8: {
        ...
        move: '12',
        weapons: [],
        abilities: ['Reposition [4]', 'Target Designator'],
        traits: ['Surveyor'],
        cards_front: [],
        card_back: '',
    },
    MAMMOTH_9: {
        ...
        weapons: [
            {
                name: 'Thermobaric Rocket Battery [2 ATKS]',
                range: '18',
                accuracy: '4',
                damage: '6',
                keywords: ['2x'],
        ...
        abilities: ['Smoke Grenades [2]'],
        traits: ['Surveyor', 'Armored', 'Transport [2]'],
        cards_front: [],
        card_back: '',
    },
    MANTIS_10: {
    ...
    RAVEN_13: {
        ...
        abilities: ['Precision Support: Ground', 'Reposition [8]'],
    ...
    ROC_15: {
        ...
        weapons: [
            {
                name: 'Heavy Guided Missiles [2 ATKS] [AP]',
                range: '10',
                accuracy: '4',
                damage: '6',
                keywords: ['2x', 'AP'],
        ...
        abilities: ['Reposition [6]'],
        traits: ['Aircraft: VTOL', 'Armored', 'Transport [2]'],
        cards_front: ['Roc.png'],
    ...
    TITAN_17: {
        ...
        weapons: [],
        abilities: ['Reposition [4]'],
        traits: ['Aircraft: VTOL', 'Armored', 'Heavy Lift Transport [1]'],
        cards_front: [],
        card_back: '',
    },
    ZEUS_18: {
